...
export const InputText = ({ $title: $title, $view="default",$name, $type, $onChange, $value}: InputProps) => {
  return (
    <StyledInput type={$type} title={$title} name={$name} $view={$view} onChange={$onChange} value={$value}/>
  );
};
